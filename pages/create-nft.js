            ...
            <div className='bg-[#0D0F23] dark:bg-white'>
                <div className='w-full 2xl:max-w-screen-2xl h-auto pt-[104px] m-auto'>
                    <div className='flex flex-col mx-8 sm:mx-12 lg:mx-[9vw] space-y-6 py-12 text-white dark:text-gray-800'>
                        ...
                        <p className='text-xl'>The first thing you will need to do to set up a Metamask wallet, Creating a MetaMask wallet is simple and free. This wallet can hold your NFTs and you will also need to use it to pay blockchain gas fees later on. </p>
